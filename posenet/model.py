...
import os
import posenetpython.posenet.converter.config
...
def load_config(model_ord):
    converter_cfg = posenetpython.posenet.converter.config.load_config()
...
def load_model(model_id, sess, model_dir=MODEL_DIR):
    ...
    if not os.path.exists(model_path):
        ...
        from posenetpython.posenet.converter.tfjs2python import convert
